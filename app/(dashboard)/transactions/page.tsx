...
import { ClipboardX, Loader2, Plus, Upload } from 'lucide-react';
...
import { useNewRequest } from '@/features/transactions/hooks/use-new-request';
import { useGetRequests } from '@/features/transactions/api/use-get-requests';
import { useBulkCreateRequests } from '@/features/transactions/api/use-bulk-create-requests';;
...
import { useUnAssignmentRequest } from '@/features/requests/hooks/use-new-unassignment-request';
...
export default function TransactionsPage(props: Props) {
    ...
    const useUnAssign = useUnAssignmentRequest();
            ...
            <div className='max-w-screen-2xl mx-auto w-full pb-10 -mt-24'>
                <Card className='border-none drop-shadow-sm'>
                    ...
                    <CardContent>
                        ...
                        {user?.role?.name !== "COMMERCIAL" && (
                            <>{
                                hasPermission(user, "TRANSACTION-ASSIGN") && (
                                    <div className='gap-x-2 flex justify-end items-center'>
                                        <Button
                                            onClick={useUnAssign.onOpen}
                                            size="sm">
