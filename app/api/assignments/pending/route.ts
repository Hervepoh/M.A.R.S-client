...
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${NEXT_PUBLIC_SERVER_URI}/assignments/pending?page=${page}&limit=${limit}&filters=${encodeURIComponent(filters)}`, {
            method: 'GET',
            headers: {
        ...
        console.log("[ASSIGNMENT-PENDING-LIST]", error);
